...
msfconsole_installed = is_command_installed("msfconsole")
wireshark_installed = is_command_installed("wireshark")
pacman_installed = is_command_installed("pacman")
...
if not pacman_installed:
    print("Pacman is not installed. Please install Pacman manually.")
    exit(1)
...
if not wireshark_installed:
    ...
    if input() == "y":
        try:
            os.system("sudo pacman -S wireshark-qt")
        except:
